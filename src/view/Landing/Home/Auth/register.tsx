...
const RegisterModal: React.FC = () => {
  ...
  return (
    <>
      {isOpen && (
        <div
          className="fixed inset-0 z-50 overflow-y-auto bg-gray-800 bg-opacity-75"
          onClick={handleCloseModal}
        >
          <div className="flex items-center justify-center min-h-screen">
            <div
              className="relative flex flex-col text-gray-700 bg-white shadow-md max-w-screen-md w-full mx-4 rounded-xl bg-clip-border"
